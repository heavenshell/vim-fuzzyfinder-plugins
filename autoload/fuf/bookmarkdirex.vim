...
" Copyright (c) 2012 Shinya Ohyanagi <sohyanagi@gmail.com>
"
"=============================================================================
" LOAD GUARD {{{1
...
"
function fuf#bookmarkdirex#createHandler(base)
  return a:base.concretize(copy(s:handler))
endfunction

"
function fuf#bookmarkdirex#getSwitchOrder()
  return g:fuf_bookmarkdir_switchOrder
endfunction

"
function fuf#bookmarkdirex#getEditableDataNames()
  return ['items']
endfunction

"
function fuf#bookmarkdirex#renewCache()
endfunction

"
function fuf#bookmarkdirex#requiresOnCommandPre()
  return 0
endfunction

"
function fuf#bookmarkdirex#onInit()
  call fuf#defineLaunchCommand('FufBookmarkDirEx', s:MODE_NAME, '""', [])
  command! -bang -narg=?        FufBookmarkDirExAdd call s:bookmark(<q-args>)
endfunction
